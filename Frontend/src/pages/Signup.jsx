            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all duration-200 sm:text-sm"
                ...
                {formData.password && (
                  <div className="mt-2 space-y-2">
                      ...
                      <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                        <div 
                          className={`h-full transition-all duration-300 ${
                            ...
                            passwordStrength === 'fair' ? 'w-2/4 bg-orange-500' :
                            passwordStrength === 'good' ? 'w-3/4 bg-yellow-500' :
                    ...
                    <div className="text-xs space-y-1.5">
                      ...
                      <div className={`flex items-center gap-1.5 ${/[^a-zA-Z0-9]/.test(formData.password) ? 'text-green-600' : 'text-gray-400'}`}>
                        <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="h-4 w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded mt-1 cursor-pointer"
                />
